...
RSpec.describe Team, type: :model do
  before (:each) do
    ...
    @hunt = Hunt.create(location: Location.first, start_time: DateTime.news(2018, 1, 1, 12, 00, 00), finish_time: DateTime.new(2018, 1, 1, 15, 00, 00), user: @user1, name: "Test Hunt")
